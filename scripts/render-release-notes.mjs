...
function renderGithubReleaseNotes({ note, tag, installer, sha256, extraNotes }) {
  ...
  const lines = [
    ...
    `- SHA256: \`${sha256.trim()}\``,
    "- macOS universal DMG and updater archive are attached after the macOS release job completes.",
    "",
    ...renderMarkdownSections(note.sections),
    "## Install notes",
    "",
    "This is an unsigned private alpha. Windows may show SmartScreen, and macOS may show Gatekeeper warnings. Choose More info / Open only if you trust this release.",
    "",
