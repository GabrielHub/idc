    ...
    steps: [
      {
        ...
        target: "pulse-ring",
        placement: "right",
        title: TUTORIAL_COPY["planning.layer-nav"].title,
        body: TUTORIAL_COPY["planning.layer-nav"].body,
        primaryLabel: TUTORIAL_COPY["planning.layer-nav"].primaryLabel,
        stepIndex: TUTORIAL_COPY["planning.layer-nav"].stepIndex,
        stepCount: TUTORIAL_COPY["planning.layer-nav"].stepCount,
      },
      {
        id: "planning.focus",
        ...
        target: "pulse-ring",
        placement: "right",
        title: TUTORIAL_COPY["planning.focus"].title,
        body: TUTORIAL_COPY["planning.focus"].body,
        stepIndex: TUTORIAL_COPY["planning.focus"].stepIndex,
        stepCount: TUTORIAL_COPY["planning.focus"].stepCount,
      },
      {
        id: "planning.partner",
        ...
        target: "pulse-ring",
        placement: "right",
        title: TUTORIAL_COPY["planning.partner"].title,
        body: TUTORIAL_COPY["planning.partner"].body,
        stepIndex: TUTORIAL_COPY["planning.partner"].stepIndex,
        stepCount: TUTORIAL_COPY["planning.partner"].stepCount,
      },
      {
        id: "planning.intent",
        ...
        body: TUTORIAL_COPY["planning.intent"].body,
        primaryLabel: TUTORIAL_COPY["planning.intent"].primaryLabel,
        stepIndex: TUTORIAL_COPY["planning.intent"].stepIndex,
        stepCount: TUTORIAL_COPY["planning.intent"].stepCount,
      },
      {
        id: "planning.commit",
        ...
        body: TUTORIAL_COPY["planning.commit"].body,
        primaryLabel: TUTORIAL_COPY["planning.commit"].primaryLabel,
        stepIndex: TUTORIAL_COPY["planning.commit"].stepIndex,
        stepCount: TUTORIAL_COPY["planning.commit"].stepCount,
      },
      {
        ...
        body: TUTORIAL_COPY["planning.scenario"].body,
        stepIndex: TUTORIAL_COPY["planning.scenario"].stepIndex,
        stepCount: TUTORIAL_COPY["planning.scenario"].stepCount,
      },
      {
        id: "planning.begin",
        ...
        body: TUTORIAL_COPY["planning.begin"].body,
        stepIndex: TUTORIAL_COPY["planning.begin"].stepIndex,
        stepCount: TUTORIAL_COPY["planning.begin"].stepCount,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        target: "spotlight",
        placement: "top",
        title: TUTORIAL_COPY["date.footer.health"].title,
        body: TUTORIAL_COPY["date.footer.health"].body,
        primaryLabel: TUTORIAL_COPY["date.footer.health"].primaryLabel,
        stepIndex: TUTORIAL_COPY["date.footer.health"].stepIndex,
        stepCount: TUTORIAL_COPY["date.footer.health"].stepCount,
      },
      {
        ...
        target: "pulse-ring",
        placement: "top",
        title: TUTORIAL_COPY["date.footer.transport"].title,
        body: TUTORIAL_COPY["date.footer.transport"].body,
        stepIndex: TUTORIAL_COPY["date.footer.transport"].stepIndex,
        stepCount: TUTORIAL_COPY["date.footer.transport"].stepCount,
      },
      {
        id: "date.judge-note",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        target: "pulse-ring",
        placement: "bottom",
        title: TUTORIAL_COPY["planning.file-shift"].title,
        body: TUTORIAL_COPY["planning.file-shift"].body,
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        target: "coach-only",
        placement: "left",
        title: TUTORIAL_COPY["lazy.contextual-rail"].title,
        body: TUTORIAL_COPY["lazy.contextual-rail"].body,
        primaryLabel: TUTORIAL_COPY["lazy.contextual-rail"].primaryLabel,
      },
      {
        id: "lazy.date-book",
        ...
        target: "pulse-ring",
        placement: "left",
        title: TUTORIAL_COPY["lazy.date-book"].title,
        body: TUTORIAL_COPY["lazy.date-book"].body,
        primaryLabel: TUTORIAL_COPY["lazy.date-book"].primaryLabel,
      },
      {
        id: "lazy.cut-short",
        ...
        target: "pulse-ring",
        placement: "top",
        title: TUTORIAL_COPY["lazy.cut-short"].title,
        body: TUTORIAL_COPY["lazy.cut-short"].body,
        primaryLabel: TUTORIAL_COPY["lazy.cut-short"].primaryLabel,
      },
      {
      ...
      },
      {
        ...
        target: "coach-only",
        placement: "left",
        title: TUTORIAL_COPY["lazy.datebook.locked"].title,
        body: TUTORIAL_COPY["lazy.datebook.locked"].body,
        primaryLabel: TUTORIAL_COPY["lazy.datebook.locked"].primaryLabel,
      },
      {
        ...
        target: "pulse-ring",
        placement: "left",
        title: TUTORIAL_COPY["lazy.datebook.repair"].title,
        body: TUTORIAL_COPY["lazy.datebook.repair"].body,
        primaryLabel: TUTORIAL_COPY["lazy.datebook.repair"].primaryLabel,
      },
      {
        ...
        target: "pulse-ring",
        placement: "right",
        title: TUTORIAL_COPY["lazy.cooldown-block"].title,
        body: TUTORIAL_COPY["lazy.cooldown-block"].body,
        primaryLabel: TUTORIAL_COPY["lazy.cooldown-block"].primaryLabel,
      },
      {
        ...
        target: "coach-only",
        placement: "right",
        title: TUTORIAL_COPY["lazy.closure-ready"].title,
        body: TUTORIAL_COPY["lazy.closure-ready"].body,
        primaryLabel: TUTORIAL_COPY["lazy.closure-ready"].primaryLabel,
      },
      {
