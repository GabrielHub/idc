...
const FIRST_TIME_FLOW: FlowPhase[] = [
  ...
  },
  {
    ...
    tone: "fuchsia",
    caption:
      "Constellation lobby. The layer indicator threads the player through focus → roster → cathedral; the BottomDock Begin button commits + starts in one tap.",
    steps: [
      {
        id: "planning.focus",
        surface: "Constellation lobby · LayerIndicator focus pill",
        trigger: "Lobby is open with no focus case picked yet.",
      ...
      },
      {
        ...
        trigger:
          "Partner is picked and the player is still on a member layer (i.e. has not entered the cathedral).",
        completesOn:
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        surface: "Constellation lobby · focus layer star",
        trigger: "Lobby is open on the focus layer and a focused member is in cooldown.",
        completesOn: "The Got it button.",
        target: "coach-only",
        placement: "right",
        title: "One of these is in cooldown",
        body: "A focus star dims and recedes when the member needs space after their last date. Cooldowns end on the next shift. Their HoverDetailCard shows the status.",
        primaryLabel: "Got it",
      },
      {
        id: "lazy.closure-ready",
        surface: "Constellation lobby · CalloutCluster",
