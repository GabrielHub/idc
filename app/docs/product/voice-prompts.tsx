      ...
      <>
        ...
        <DocList
          items={[
            ...
            "Voice flavor: compact register, comedy mechanics, and tics. The sit-down opener may surface two greeting samples; the conversation-shape and contrastive-example galleries and the in-date sample banks do not flow into the prompt (the model recites galleries verbatim, so voice rides on register, mechanics, and tics). A single crash-out attractor surfaces only when date health is low and a dealbreaker fire is imminent.",
