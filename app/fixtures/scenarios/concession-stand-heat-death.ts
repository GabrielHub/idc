    ...
    events: [
      {
        ...
        directorInstruction:
          "Open the date with a small concrete decision. Let either of them order without ceremony. The cook does not speak.",
      },
      {
        ...
        directorInstruction:
          "Use the small coupon to test whether either of them treats the venue as a transaction or as an evening, drawn from each member's existing stance on small luxury.",
      },
      {
        ...
        directorInstruction:
          "Allow the small countdown without making it a deadline. The pair is not in danger. Do not voice any background person or cue as a continuing speaker.",
      },
      {
        ...
        directorInstruction:
          "Let the small future entry do its work without becoming the topic. Either may sign or leave it. Do not voice any background person or cue as a continuing speaker.",
      },
      {
        ...
        directorInstruction:
          "Use the food to test small generosity. Either may hand the boat across or take from the middle. Do not voice any background person or cue as a continuing speaker.",
      },
      {
        ...
        directorInstruction:
          "Use the small body cue to test whether either of them adjusts for the partner's comfort. Do not voice any background person or cue as a continuing speaker.",
      },
      {
        ...
        directorInstruction:
          "Allow the small skip. The pair does not need to comment on time. Either may name the next move. Do not voice any background person or cue as a continuing speaker.",
      },
      {
        ...
        directorInstruction:
          "Push for a clean ordinary exit. A walk back to the booth, a quiet thank you, or the choice to stay another forty minutes are all real outcomes. Do not voice any background person or cue as a continuing speaker.",
      },
      {
        id: "concession-stand-heat-death-event-9",
        title: "Window shutter",
        kind: "provocation",
        event: "A metal shutter rolls halfway down across the order window.",
        characterVisibleText:
          "A metal shutter rolls halfway down across the order window. The fryer light cuts to half. The receipt is still on the counter under the shutter line.",
        directorInstruction:
          "Push for a clean physical move: take the receipt, ask the cook to hold the shutter, or step back from the window. The shutter will keep coming.",
      },
    ],
    earlyEndTriggers: [
