    ...
    events: [
      {
        ...
        directorInstruction:
          "Open the set quietly. Let either of them adjust to the new time signature.",
      },
      {
        ...
        directorInstruction:
          "Use the small forced presence to test whether either of them treats it as loss or as freedom.",
      },
      {
      ...
      },
      {
        ...
        directorInstruction:
          "Use the silence as the test. Either of them may speak or hold the quiet. Either is right if it is honest.",
      },
      {
      ...
      },
      {
        ...
        directorInstruction:
          "Let the second half of the set carry. The pair does not need to fill it.",
      },
      {
        ...
        directorInstruction:
          "Push for one direct line about what either of them wants from the rest of the set.",
      },
      {
        ...
        directorInstruction:
          "Push for a clean exit. The pair walks the aisle together or separately. Either is the right answer if it is chosen.",
      },
    ],
    earlyEndTriggers: [
