    ...
    events: [
      {
        ...
        directorInstruction:
          "Use the rule sheet as a real document. Either of them may read it aloud or skip it.",
      },
      {
      ...
      },
      {
        ...
        directorInstruction:
          "Allow the small noticing without giving the villager a line of dialogue. The pair does not have to respond to it.",
      },
      {
        ...
        directorInstruction:
          "Use the small loss of control over interpretation to test whether either of them wants to send a sign anyway.",
      },
      {
        ...
        directorInstruction:
          "Use the small invitation to step away as a real option. Either pressing or declining is a real choice.",
      },
      {
        ...
        directorInstruction:
          "Allow the question to go unanswered if that is what the pair chooses. Do not invent a reply field. The world handles its own theology.",
      },
      {
        ...
        directorInstruction:
          "Push for a clean read on how the pair leaves the world. A clean step-away, a final small action, or a quiet log-out are all real outcomes.",
      },
    ],
    earlyEndTriggers: [
