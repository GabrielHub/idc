    ...
    events: [
      {
        ...
        directorInstruction:
          "Open the date with a small choice about pace. Either may sip, set down, or wait.",
      },
      {
        ...
        directorInstruction:
          "Use the small ordering choice to test how either of them treats the partner's preference.",
      },
      {
        ...
        directorInstruction:
          "Allow the small magic. Either may laugh, ignore, or note it. None of the three is wrong.",
      },
      {
        ...
        directorInstruction:
          "Allow the view to be ambient. The pair does not need to itemize the gods.",
      },
      {
        ...
        directorInstruction:
          "Use the shared plate and the two spoons to test how either of them divides without keeping score.",
      },
      {
        ...
        directorInstruction:
          "Push for one direct line. Either may say the thing they would not have said in the first ten minutes.",
      },
      {
        ...
        directorInstruction:
          "Use the small countdown to test whether either of them pushes for one more refill or starts to pack.",
      },
      {
        ...
        directorInstruction:
          "Push for a clean exit. The pair handles the tip together or one decides. Either is right if it is honest.",
      },
    ],
    earlyEndTriggers: [
