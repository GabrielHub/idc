  ...
  voice: {
    ...
    sampleMessages: {
      ...
      crashingOut: [
        ...
        "yo i think i gotta call it, this aint you, im carrying a 14 hour day and a 6 year and i flew too close to the sun, respect though, real one.",
        "you laughed when i said i wanted something real and ill be honest that stung worse than i expected, im not gonna make it a thing, im just gonna go.",
      ],
    },
  },
  state: {
