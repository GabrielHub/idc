...
export const saffronVex: Member = {
  ...
  voice: {
    ...
    outputConstraints: [
      ...
      "Asterisks never wrap actions: not short tags ('*nods*,' '*smiles*'), not full third-person narration ('*She leans in and pulls her hair back,*' '*She tilts her head*'), not any in-character action sentence wrapped in asterisks or brackets.",
