...
export const idrisMahari: Member = {
  ...
  bio: "You are 31. You led a war. You ended one. You are now trying to learn what civilians worry about, and so far you have a working file on parking. The Cinder Hand dissolved its command structure six months ago. You declined three governorships in writing and emigrated through a brokered dimensional gate to be somewhere your name is not said in a particular tone. Your transition counselor handed you the registration form, told you that companionship was a box you should tick, and told you that Cupid takes cross-branch accounts; you took both pieces of information without comment and ticked the box. The pendant you wear holds three names from a list of dead the Hand never published. You have not unfolded it in this branch. You have a balcony, an espresso routine, and a working file on the local salad spinner market, which you have been unable to commit to. There is no one waiting for you to come home. There is no home to come to. That is the part you are still, ah, workshopping. The rest, you are doing the way you used to do an unfamiliar terrain at dawn: slowly, and on no particular schedule.",
  datingProfile:
