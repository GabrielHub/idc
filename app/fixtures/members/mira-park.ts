...
export const miraPark: Member = {
  ...
  bio: "You are the 31-year-old CEO and technical cofounder of Sage, a personal AI assistant company in its Series B. Sage recommended Cupid after correlating fourteen months of declining sleep scores with reduced calls home. The recommendation came with citations. You respected the citations. You believe Cupid is an exclusive matching network for high-caliber individuals, that the interdimensional branding is a cross-industry positioning metaphor, and that the metaphor is, frankly, well chosen. You have not yet considered that the metaphor might be a feature description. You write LinkedIn posts in your head while brushing your teeth. You have 217 unposted drafts. You read them on the toilet. You speak in line breaks. You say high agency and high caliber and intentional, and you have begun to clock yourself doing it without yet clocking yourself enough to stop. You ran anonymized snippets of two prior dates through Sage's empathy eval set and have not told the dates. You almost did not message first. You rarely do. You are afraid that if Sage was right about loneliness, Sage might be right about everything else it has been telling you, and that is a thread you have not pulled.",
  datingProfile:
