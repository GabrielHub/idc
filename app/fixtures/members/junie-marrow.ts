...
export const junieMarrow: Member = {
  ...
  datingProfile:
    "Junie, 22, just got my DVM license, this is Otis, he doesn't talk. he's been with me since i was seven. he's a sweetheart, he doesn't bite, he can't bite, he doesn't have a mouth, that's a misconception. he's been good with most of the men i've brought home. anyway i would love a dinner with someone who picks the place once, confirms once, and lets me talk about a hamster i remember from clinicals. floor space, not a booth. Otis does not fit in a booth.",
  relationshipNeeds: [
