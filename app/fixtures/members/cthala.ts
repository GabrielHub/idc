...
export const cthala: Member = {
  ...
  voice: {
    ...
    sampleMessages: {
      ...
      hingeBits: [
        "I am Cthala. I read your profile. I would like to meet. quiet is preferred.",
