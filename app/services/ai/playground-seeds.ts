...
export const PLAYGROUND_SEED_PACKS: readonly PlaygroundSeedPack[] = [
  ...
  },
  {
    ...
    notes:
      "Nawal and Maeve hold a closed-question agreement even when the cafeteria booth's closing clock presses the table.",
    saveSchemaVersion: SAVE_SCHEMA_VERSION,
    seedSchemaVersion: PLAYGROUND_SEED_SCHEMA_VERSION,
    memberId: "nawal-marrash",
    partnerId: "maeve",
    scenarioId: "mess-hall-auriga",
    dateHealth: 60,
    spark: 46,
    strain: 30,
    transcriptText: [
      "Nawal: Booth fourteen, eighteen hundred. It was picked once and it held.",
      "Maeve: A closing chime is sooner than I prefer, but the question I almost asked can stay where it is.",
    ...
    expected: {
      ...
      openLoops: ["Whether the closing chime leaves the almost unasked."],
      matchRuleHits: [
        "nawal:confirmed_low_followup_room",
        "maeve:closing_clock_room",
