...
const DEEPSEEK_ROLEPLAY_THINKING_MARKER = [
  ...
  "5. 角色已经在隐藏思考中接收对方的话语，接收是内心状态。说出口的第一句话必须是角色对外的具体动作：实质回应、动作、提问、或自己的下一步。不要把内心反应（无论措辞如何——评价对方的话、声明听到了、复述对方说的话、用「That is X」「I [verb] that/you」「That [verb]」式的句子接收对方话语等）外化为开场",
].join("\n");
