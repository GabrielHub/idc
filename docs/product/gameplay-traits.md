...
- **Sincerity tribe**: Jenna, Sana, Marcus, Toby, Mei, Ryan, Junie. Marcus + Sana, Marcus + Jenna, Toby + Sana all warm. Mundane domesticity, low pressure, no performance. Mei sits at the high-energy end of the cluster: hyperfocused on her craft, no bit, lets others finish a sentence because she expects the same. Ryan sits at the loud end: bro register on top of sincerity, fresh out of a six year, attention-seeking volume wrapping the same low-pressure ask as the rest. The tribe absorbs him only when partners read the wrapper as wrapper. Junie sits adjacent: vet sincerity wraps a baseline ventriloquy that inserts Otis into every other sentence; the tribe absorbs her when partners read the ventriloquy as a tic rather than a tell and stop testing whether Otis is real, alive, or listening.
- **Ceremony tribe**: Vhool, Aldric, Eleanor, Decimus, Wenshu, Anubis. Aldric + Vhool (sacred bargain), Aldric + Decimus (soldiers), Eleanor + Decimus (cold formal pair), Wenshu + Vhool (Dao-talk meets Pact-talk, same dialect of seriousness). Shared formal cadence reads as fluency. Anubis sits at the irreverent edge: he chairs an actual ritual office (the Forty-Two, the weighing, the Hall of Two Truths) but performs it in lounge cadence, so ceremony peers read him as a peer until he says something flippant about the office and the room cools.
...
- **Career grind**: Tasha, Mr. Whiskers, Meridian, Marcus, Sera, Anubis. Calendars, decisive plans, no negotiation. Sera + Tasha share confirmation discipline; Sera + Eleanor share Term-and-Bargain protocol fluency. Anubis runs the Forty-Two as a department, brings the same calendar discipline, and treats the divine office as senior shop across pantheons.
...
- **Competitive collisions**: Venus vs Tasha, Venus vs Mr. Whiskers, Mr. Whiskers vs Tasha, Venus vs Anubis (two vain deities at the same maitre d's bow). Spark high, trust low.
...
- Junie vs Marcus: mundane domesticity meets vet sincerity. Marcus has a dog and a parking lot routine; Junie has a hamster story and a stone guardian who fits on the floor. Neither asks the other to be a project. He treats Otis as a chair situation that resolves itself; she takes the early-dinner slot at face value. Probably her cleanest closer in the roster.
- Junie vs Nawal: civil-service silence meets baseline ventriloquy. Otis being still and unspeaking does not bother Nawal at all; she has held many silences and treats the ventriloquy as the same kind of meal continuing. The hamster-Bartlett story lands as plain talk, the Otis votes-for-the-wine line lands as plain talk, and neither has to perform recovery for the other.
- Junie vs Naia: face-value compliments and face-value disclosures, on both sides. Naia greets Otis by name and asks how old he is; Junie answers fifteen and is corrected only by her own count of him. Compliments do not get counted on either side and the eye count is taken seriously.
- Junie vs Aldric: sworn knight reads Otis as a guardian-familiar of the household. He recognizes the pattern from his order, calls Otis the watch, and treats his presence as honor done to the table. Junie does not understand the framing and is relieved by it.
- Junie vs Reaver: he prices Otis as Equity inside the first message and asks whether the bonded household guardian transfers with the Patron arrangement. The Captain reads Otis as honor guard, which lands as flattering and disqualifying at once. Junie has no Liquidity and Otis is not on a manifest. Soft cold breach by the second course, both parties calm.
- Junie vs Kade: he reaches for the phone within five minutes to film Otis. The ring-light dealbreaker fires; the constant ventriloquy reads to him as a bit he wants to capture, and the dating profile line about not filming the table goes unread. Hard exit before the appetizer.
- Junie vs Mr. Whiskers: he refuses informal register and baby talk; her lowercase i, vet voice, and Otis-says-hi cadence fire both lines inside the first message. He also reads Otis at the table as a chair situation that is not civilized and asks counsel to reassign the reservation. Formal collapse by the entree.
- Junie vs Cha: combat-strength filter clocks Otis as adjacent to the shades he hunts. Cha lands two-word replies through warming and does not soften toward the eye-count tells. The ventriloquy reads as wrong category, the hamster-Bartlett story does not. Polite cold exit by the second course.
- Anubis vs Venus: two vain deities at the same maitre d's bow. Venus counts compliments; Anubis flexes the office. Whoever the bow goes to first sets the tone for the rest of the meal, and both register the count silently. Volatile-warm if either yields the first name without protest; otherwise the loudest exit in the roster by the appetizer, both parties insisting they are leaving first.
- Anubis vs Mr. Whiskers: business-class mutual courtesy in a new shape. Both refuse to address the obvious species question, both treat their work as a senior office, both hold professional register through the entree. Surprise warm. The risk is one of them naming what the other actually is, after which counsel arrives at both ends of the table.
- Anubis vs Sera Vohn: the Forty-Two judges meet Standard Terms. He chairs a review board on the weighing of hearts; she audits cohabitation contracts. Either fluent professional recognition (two operators comparing audit instruments) or a contractual feud about whether week-three review applies to soul weighing. Clipped enough to lock, translatable enough to land.
- Anubis vs Opal: she clocks judge of souls before the appetizer and her binder fires on the second course. He drops the Hall of Two Truths casually, names the weighing as the day job, and the prophecy-averse line gets crossed without him noticing. Hard exit, both calm at the door, neither having raised their voice.
- Anubis vs Anansi: two performer-gods at the same table. Anansi tells a small lie aloud; Anubis names it out of professional courtesy (the weighing is the day job) and the trick has nowhere to land. Mutual operator recognition becomes mutual operator destruction by dessert. Volatile-warm if both crack at the same time; otherwise the bit dies and one of them leaves first.
- Anubis vs Cassie Conners: brand asset meets executive brand. He pitches the Hall of Two Truths like a season pilot; she clocks the brand voice on the second sentence. Either she softens and lets the pitch breathe, or the release-form energy fires and the dinner ends in mutual professional courtesy. The recording line never gets tripped because both already know.
- Anubis vs sincerity tribe (Sana, Marcus, Toby, Jenna, Mei, Ryan, Junie): worst-date-ever territory in a new shape. Sincerity-seekers read the divine lounge bravado as exhausting; Anubis reads the request for ordinary conversation as a downgrade. Hard exit before dessert in most cases, both parties certain the other was the problem.
...
- The save owns `focusedMemberIds`, capped at 4. Onboarding requires exactly 4 selected from the 40 active members; closures free a slot. `app/services/focus-cases.ts` exposes `selectInitialFocusCases`, `addFocusCase`, `removeFocusCase`, and `swapFocusCase`. The shift's `featuredMemberIds` mirror `focusedMemberIds` for backwards compatibility.
